        ...
        <Container>
          ...
          >
            ...
            <p className="boxParagraph">
              Simple Subtraction, it is enough just to deactivate the number of
              balls necessary on each bar (stem).
            </p>
          </div>
        </Container>
      </div>
        ...
        <Container>
          ...
          >
            <h2 className="boxheading" style={{}}>
              Subtract Numbers on <br /> the Abacus
            </h2>
            <div
